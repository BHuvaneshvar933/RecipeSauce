      ...
      <div className="px-4 sm:px-5 rounded-lg font-noto-sans mb-8">
        <div className="myImg rounded-lg font-noto-sans sm:px-10 pt-12 grid grid-cols-1 sm:grid-cols-2 mb-6">
          <div className="mb-8">
            ...
            Embark on a journey of flavors from around the world. From spicy curries to delicate pastries, every dish tells a story of tradition and passion. Discover the magic of food that brings people together. Let the adventure begin!
            </p>
            <div className="px-2">
              <Link to="/recipes">
          ...
          <div className="basis-full sm:basis-3/4 bg-[#eeeeee] rounded-xl px-4 sm:px-5 pb-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="pt-6">
                ...
                Your culinary journey, your way. Explore recipes and experiences tailored to your tastes and preferences.
                </p>
              </div>
              <div className="pt-6">
                <h1 className="mb-6 text-black font-bold">
                ...
                <p className="text-sm text-zinc-700">
                From exotic cuisines to comforting classics, discover a wide variety of recipes that suit every mood and occasion.
                </p>
              </div>
              <div className="pt-6">
                <h1 className="mb-6 text-black font-bold">
                ...
                <p className="text-sm text-zinc-700">
                Join a vibrant community of food lovers. Share, learn, and connect with others who share your passion for delicious adventures.
                </p>
              </div>
            </div>
          </div>
